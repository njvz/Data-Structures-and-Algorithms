...
public class StringNode2 {
    private char ch;
    private StringNode2 next;

    /*
     * Constructor
     */
    public StringNode2(char c, StringNode2 n) {
        this.ch = c;
        this.next = n;
    }
     ...
     */
    private static StringNode2 getNode(StringNode2 str, int i) {
     ...
     */
    public static char charAt(StringNode2 str, int i) {
        if (str == null) {
            throw new IllegalArgumentException("the string is empty");
        } 
          
        StringNode2 node = getNode(str, i);
     ...
     */
    public static int compareAlpha(StringNode2 str1, StringNode2 str2) {
     ...
     */
    public static StringNode2 convert(String s) {
        if (s.length() == 0) {
            return null;
        }

        StringNode2 firstNode = new StringNode2(s.charAt(0), null);
        StringNode2 prevNode = firstNode;
        StringNode2 nextNode;

        for (int i = 1; i < s.length(); i++) {
            nextNode = new StringNode2(s.charAt(i), null);
     ...
     */
    public static StringNode2 copy2(StringNode2 str) {
        if (str == null) {
            return null;
        }
        ...
        StringNode2 copyFirst = new StringNode2(str.ch, null);
     ...
     */
    public static StringNode2 deleteChar(StringNode2 str, int i) {
        if (str == null) {
            ...
            StringNode2 prevNode = getNode(str, i-1);
     ...
     */
    public static void doubleChar(char c, StringNode2 str) {
        if (str == null) {
            return;
        }
        ...
        if (str.ch == c) {
            StringNode2 doubleCurrent = new StringNode2(c, str.next);
     ...
     */
    public static StringNode2 insertBefore(StringNode2 str, char newChar, 
                                         char beforeChar) 
    {
        StringNode2 newNode = new StringNode2(newChar, null);
        ...
        StringNode2 trail = null;
        StringNode2 trav = str;
        while (trav != null) {
     ...
     * Returns a reference to the resulting linked-list string.
     */
    public static StringNode2 insertChar(StringNode2 str, int i, char ch) {
        StringNode2 newNode, prevNode;

        if (i < 0) { 
            throw new IllegalArgumentException("invalid index: " + i);
        } else if (i == 0) {
            newNode = new StringNode2(ch, str);
            str = newNode;
        } else {
            prevNode = getNode(str, i - 1);
            if (prevNode != null) {
                newNode = new StringNode2(ch, prevNode.next);
     ...
     */
    public static StringNode2 insertSorted(StringNode2 str, char ch) {
        StringNode2 newNode, trail, trav;
        ...
        newNode = new StringNode2(ch, trav);
        if (trail == null) {
     ...
     */
    public static int length(StringNode2 str) {
        if (str == null) {
            return  0;
        } else {
     ...
     */
    public static int numOccur(StringNode2 str, char ch) {
        if (str == null) {
            return 0;
        }
     ...
     */
    public static void print(StringNode2 str) {
        if (str == null) {
            return;
        } else {
     ...
     */
    public static StringNode2 read(InputStream in) throws IOException { 
        char ch = (char)in.read();

        if (ch == '\n') {    // the string ends when we hit a newline character
            return null;         
        } else {
            StringNode2 restOfString = read(in);
            StringNode2 first = new StringNode2(ch, restOfString);
            return first;
        }
    }
     ...
     * the current StringNode2 represents.  Note that this
    ...
    public String toString() {
        ...
        StringNode2 trav = this;   // start trav on the current node    
        while (trav != null) {
            str = str + trav.ch;
            trav = trav.next;
        }
     ...
     */
    public static void toUpperCase(StringNode2 str) {        
        StringNode2 trav = str; 
        while (trav != null) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        StringNode2 str1 = StringNode2.convert(s);
        System.out.print("Here it is in upper-case letters: "); 
        StringNode2.toUpperCase(str1);
        System.out.println(str1);
        
        // length
        int len = StringNode2.length(str1);
        System.out.println("Its length is " + len);

        // copy and deleteChar
        System.out.print("\nEnter another string: ");
        s = in.nextLine();
        StringNode2 str2 = StringNode2.convert(s);
        System.out.print("Making a copy of it...");
        StringNode2 copyStr2 = StringNode2.copy(str2);
        ...
        try {
            str2 = StringNode2.deleteChar(str2, n);
            StringNode2.print(str2);
        ...
        System.out.print("\nEnter another string: ");
        s = in.nextLine();
        StringNode2 str3 = StringNode2.convert(s);
        System.out.print("comparing " + str2 + " and " + str3 + " gives: ");
        System.out.println(StringNode2.compareAlpha(str2, str3));   
        ...
        str2 = StringNode2.insertBefore(str2, c, before);
        System.out.println(str2);

        // doubleChar
        System.out.print("\nEnter another string: ");
        s = in.nextLine();
        StringNode2 str4 = StringNode2.convert(s);
        System.out.print("What character to double? ");
        c = in.nextLine().charAt(0);
        StringNode2.doubleChar(c, str4);
