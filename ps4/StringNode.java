/*
 * StringNode.java
 * Practice with linked lists of StringNodes
 * 
 ...
 public class StringNode {
                                          ...
                                          char afterChar) 
     {
        if (str == null) {
            ...
            StringNode newNode = new StringNode(newChar, str);
            return newNode;     
        } 
        else {
            StringNode rest = insertBefore(str.next, newChar, afterChar);
            str.next = rest;
            return str;
        }
    }
